...
public class BDIC extends Canvas implements CommandListener{
...
BigDecimalScript bds;
Displayable displayable;

public BDIC(Display d){
...
if(cd==calc){
	try{
	v.addElement(new CanvasBox(bds.calculate(editcb.getString()),getWidth(),false));
	}catch(Exception exc){
...
public String getMessage(){
	String s="高精度计算     N:"+String.valueOf(bds.limitDig);
	return s;
}
}